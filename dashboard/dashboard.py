...
hours_df = pd.read_csv(os.path.join(BASE_DIR, "all_data.csv"))
...
ax.set_title("Casual User Ratio by Hour", fontsize=50)
ax.set_xlabel("Hour", fontsize=35)
ax.set_ylabel("Casual Ratio", fontsize=35)
plt.xticks(range(start_hour, end_hour+1), rotation=45, fontsize=25)
plt.yticks(fontsize=25)
...
st.info("""
Insight:
- Casual users peak at 14:00.
- Registered users peak during commuting hours (08:00 and 17:00).
- Casual usage dominates during midday, indicating leisure activity.
""")
